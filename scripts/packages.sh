...
if [ "$build" = true ] || [ ! -e /vagrant/*.rpm ]; then
  ...
  zypper addrepo -k -t rpm-md -n suse-13.2-oss http://download.opensuse.org/distribution/13.2/repo/oss/suse suse-13.2-oss
  zypper addrepo -k -t rpm-md -n suse-13.2-non-oss http://download.opensuse.org/distribution/13.2/repo/non-oss/suse suse-13.2-non-oss
